...
router.delete("/api/posts/delete/:id", currentuser_1.currentUser, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
      const { id } = req.params;
      const existingPost = yield Post_1.Post.findOne({ _id: id }).populate(
        "author"
      );
      if (!existingPost) {
      ...
      if (
        ...
        ((_a = req.foxxiUser) === null || _a === void 0 ? void 0 : _a.id)
      ) {
