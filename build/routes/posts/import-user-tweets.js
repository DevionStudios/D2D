...
router.post("/api/tweets", currentuser_1.currentUser, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      const usernameResponse =
        yield appOnlyClientFromConsumer.v2.userByUsername(
          existingUser.twitterUsername
        );
      const apiResponse = yield appOnlyClientFromConsumer.v2.userTimeline(
