...
router.put("/api/follow/users", currentuser_1.currentUser, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c, _d;
    try {
      const { username } = req.body;
      const existingUser = yield User_1.User.findOne({ _id: req.foxxiUser.id });
      const existingUserToFollow = yield User_1.User.findOne({
        username: username,
      });
      if (!existingUser) {
      ...
      if (existingFollow) {
        ...
        existingUser.following =
          (_a = existingUser.following) === null || _a === void 0
            ? void 0
            : _a.filter(
                (user) =>
                  user._id.toString() !== existingUserToFollow._id.toString()
              );
        // Remove the user from the followers array
        existingUserToFollow.followers =
          (_b = existingUserToFollow.followers) === null || _b === void 0
            ? void 0
            : _b.filter(
        ...
        (_c = existingUser.following) === null || _c === void 0
          ? void 0
          : _c.push(existingUserToFollow);
        (_d = existingUserToFollow.followers) === null || _d === void 0
          ? void 0
          : _d.push(existingUser);
        yield existingUser.save();
        yield existingUserToFollow.save();
