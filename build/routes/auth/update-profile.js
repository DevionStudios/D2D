...
const cloudinaryConfig_1 = __importDefault(
  require("../../config/cloudinaryConfig")
);
const multer_filefilter_config_1 = __importDefault(
  require("../../config/multer.filefilter.config")
);
...
router.put(
  ...
  multer_filefilter_config_1.default.fields([
      ...
      try {
        ...
        if (req.files) {
          ...
          if (files.image && files.image.length > 0) {
            ...
            var result = yield cloudinaryConfig_1.default.uploader.upload(
              imageFilePath
            );
        ...
        existingUser.coverImage =
          coverImageSecureUrl || existingUser.coverImage;
