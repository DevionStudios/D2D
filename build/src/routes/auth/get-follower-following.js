...
router.get("/api/users/get/social", currentuser_1.currentUser, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      if (foxxiUser) {
        ...
        const followers =
          user === null || user === void 0 ? void 0 : user.followers;
        const following =
          user === null || user === void 0 ? void 0 : user.following;
        res.json({
          followers: followers,
          following: following,
        });
