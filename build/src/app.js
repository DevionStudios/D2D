...
const create_community_1 = require("./routes/community/create-community");
const edit_community_1 = require("./routes/community/edit-community");
const get_community_1 = require("./routes/community/get-community");
const get_community_users_1 = require("./routes/community/get-community-users");
const join_community_1 = require("./routes/community/join-community");
const leave_community_1 = require("./routes/community/leave-community");
const search_community_post_1 = require("./routes/community/search-community-post");
const get_community_posts_1 = require("./routes/community/get-community-posts");
const get_user_posts_2 = require("./routes/community/get-user-posts");
const moderate_member_1 = require("./routes/community/moderate-member");
const get_communities_1 = require("./routes/community/get-communities");
const discover_community_posts_1 = require("./routes/community/discover-community-posts");
const get_user_s_communities__posts_1 = require("./routes/community/get-user's-communities'-posts");
const get_user_joined_communities_1 = require("./routes/community/get-user-joined-communities");
const get_channels_1 = require("./routes/communityChannels/get-channels");
const create_channel_1 = require("./routes/communityChannels/create-channel");
const check_community_moderator_1 = require("./routes/community/check-community-moderator");
...
app.use(create_community_1.createCommunityRouter);
app.use(check_community_moderator_1.checkCommunityModeratorRouter);
app.use(edit_community_1.editCommunityRouter);
app.use(get_user_joined_communities_1.getJoinedCommunitiesRouter);
app.use(get_communities_1.getCommunitiesRouter);
app.use(get_community_users_1.getCommunityUsersRouter);
app.use(join_community_1.joinCommunityRouter);
app.use(leave_community_1.leaveCommunityRouter);
app.use(search_community_post_1.searchCommunityPostRouter);
app.use(discover_community_posts_1.discoverCommunityPostsRouter);
app.use(get_community_posts_1.getCommunityPostsRouter);
app.use(get_user_posts_2.getCommunityUserPostsRouter);
app.use(moderate_member_1.moderateCommunityMembersRouter);
app.use(get_community_1.getCommunityRouter);
app.use(get_user_s_communities__posts_1.getUserCommunityFeedRouter);
app.use(create_channel_1.createCommunityChannelRouter);
app.use(get_channels_1.getCommunityChannelsRouter);
