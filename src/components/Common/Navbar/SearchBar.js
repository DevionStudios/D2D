      ...
      <div className="relative">
        ...
        >
          <Input
            ...
            label="Search"
            {...form.register("query")}
            className="block w-full dark:text-white bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-md py-2 pl-10 pr-3 text-sm placeholder-gray-500 focus:outline-none focus:text-gray-900 focus:placeholder-gray-400 focus:ring-1 focus:ring-blue-300 focus:border-blue-300 sm:text-sm"
