...
`PORT, MONGO_URI, JWT_KEY, CLOUDINARY_CLOUD_NAME, CLOUDINARY_API_KEY, CLOUDINARY_API_SECRET, EMAIL, EMAIL_APP_PASSWORD, HELPLINE_EMAIL, HELPLINE_EMAIL_APP_PASSWORD, TWITTER_API_KEY, ACCESS_TOKEN, ACCESS_TOKEN_SECRET`<br>
...
**EMAIL_APP_PASSWORD**- It is the gmail app password of the sender email address. It is _NOT_ the password of the google account. You need to turn on two-factor authentication for the gmail account, then make a new app and then get the app password.<br>
...
**HELPLINE_EMAIL_APP_PASSWORD**- It is the gmail app password of the helpline email address. It is _NOT_ the password of the google account. You need to turn on two-factor authentication for the gmail account, then make a new app and then get the app password.<br>
